...
LotteryWindow_Activity7 = {}
local LotteryCardId = {single = 24000121, ten = 24000122, day = 24000123}
local CostType = {Free = 1, Ticket = 2, Diamond = 3}
local countTimer = nil
local lotteryType = LotteryType.HuoDongUp7
...
LotteryWindow_Activity7.RefreshWindow = function(_uis, ...)
...
LotteryWindow_Activity7.HideOrShowFxMain = function(isShow, ...)
...
LotteryWindow_Activity7.PreLoadFxMain = function(uis, ...)
  ...
  print("---------------excelShowData.card_ids444444", excelShowData.card_ids)
  ...
  if cardNum == 1 then
    ...
    OpenWindow("CardDetailsWindow", UILayer.HUD, lotteryCardId)
            ...
            local seeBtn = ((((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).CharacterNewCardUpComp).Card_A1_Btn):GetChild("CardName")
            ;
            (seeBtn:GetController("c1")).selectedIndex = cardData.intelligence - 2
            ;
            (seeBtn:GetChild("CardTxt")).text = cardData.name
            ;
            (seeBtn:GetChild("CVTxt")).text = cardData.cv_name
          end
          do
            ...
            if bg then
              ...
              do
                ...
                for index,value in ipairs(split(excelShowData.card_ids, ":")) do
                  ...
                  ;
                  ((seeBtn:GetChild("CardName")):GetController("c1")).selectedIndex = curCardData.intelligence - 2
                  ;
                  ((seeBtn:GetChild("CardName")):GetChild("CardTxt")).text = curCardData.name
                  ;
                  ((seeBtn:GetChild("CardName")):GetChild("CVTxt")).text = curCardData.cv_name
                  ;
...
LotteryWindow_Activity7.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_Activity7.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).OneTimeBtn, LotteryCardId.single, lData.onceFreeNum)
  ;
  (LotteryWindow_Activity7.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).TenTimeBtn, LotteryCardId.ten, lData.moreFreeNum)
  ;
  (LotteryWindow_Activity7.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).SpecialOneTimeBtn, LotteryCardId.day, 0, lData.dayLottery)
end

-- DECOMPILER ERROR at PC28: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_Activity7.SetButtonInfo = function(btn, id, freeNum, dayLottery, sound, ...)
...
LotteryWindow_Activity7.ReceiveDrawedData = function(para, ...)
...
LotteryWindow_Activity7.ShowResult = function(para, ...)
...
LotteryWindow_Activity7.OnClose = function(...)
