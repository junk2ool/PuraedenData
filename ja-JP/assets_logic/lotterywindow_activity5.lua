...
LotteryWindow_Activity5 = {}
local LotteryCardId = {single = 24000101, ten = 24000102, day = 24000103}
local CostType = {Free = 1, Ticket = 2, Diamond = 3}
local countTimer = nil
local lotteryType = LotteryType.HuoDongUp5
...
LotteryWindow_Activity5.RefreshWindow = function(_uis, ...)
...
LotteryWindow_Activity5.HideOrShowFxMain = function(isShow, ...)
...
LotteryWindow_Activity5.PreLoadFxMain = function(uis, ...)
...
LotteryWindow_Activity5.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_Activity5.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).OneTimeBtn, LotteryCardId.single, lData.onceFreeNum)
  ;
  (LotteryWindow_Activity5.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).TenTimeBtn, LotteryCardId.ten, lData.moreFreeNum)
  ;
  (LotteryWindow_Activity5.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).SpecialOneTimeBtn, LotteryCardId.day, 0, lData.dayLottery)
end

-- DECOMPILER ERROR at PC28: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_Activity5.SetButtonInfo = function(btn, id, freeNum, dayLottery, sound, ...)
...
LotteryWindow_Activity5.ReceiveDrawedData = function(para, ...)
...
LotteryWindow_Activity5.ShowResult = function(para, ...)
...
LotteryWindow_Activity5.OnClose = function(...)
