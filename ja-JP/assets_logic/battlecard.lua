...
, updateNow or false, mixDuration)
  ...
  battleCard.GetBuffAttr = function(self, name, ...)
    -- function num : 0_0_152 , upvalues : _ENV, BattleBuffMgr, ipairs
    local totalValue = 0
  ...
  battleCard.GetIsReadyAtk = function(self, ...)
    -- function num : 0_0_153 , upvalues : isReadyAtk
    return isReadyAtk
  end

  battleCard.GetCampFlag = function(self, ...)
    -- function num : 0_0_154 , upvalues : campFlag
    return campFlag
  end

  battleCard.GetEnemyCampFlag = function(self, ...)
    -- function num : 0_0_155 , upvalues : enemyCampFlag
    return enemyCampFlag
  end

  battleCard.GetCurState = function(self, ...)
    -- function num : 0_0_156 , upvalues : curState
    return curState
  end

  battleCard.GetBuffTable = function(self, ...)
    -- function num : 0_0_157 , upvalues : buffTable
    return buffTable
  end
  ...
  battleCard.SetAtkInfo = function(self, info, ...)
    -- function num : 0_0_159 , upvalues : atkInfo
    atkInfo = info
  end

  battleCard.GetAtkInfo = function(self, ...)
    -- function num : 0_0_160 , upvalues : atkInfo
    return atkInfo
  end

  battleCard.SetFloatUpState = function(self, state, ...)
    -- function num : 0_0_161 , upvalues : floatUpState
    floatUpState = state
  end

  battleCard.GetFloatUpState = function(self, ...)
    -- function num : 0_0_162 , upvalues : floatUpState
    return floatUpState
  end

  battleCard.GetModel = function(self, ...)
    -- function num : 0_0_163 , upvalues : copyModel, model
    return copyModel or model
  end

  battleCard.GetShadow = function(self, ...)
    -- function num : 0_0_164 , upvalues : shadow
    return shadow
  end

  battleCard.GetFlagNextAttack = function(self, ...)
    -- function num : 0_0_165 , upvalues : flagNextAttack
  ...
  battleCard.SetSortingOrder = function(self, sortingOrder, ...)
    -- function num : 0_0_167 , upvalues : copyModel, SkeletonAnimationUtil, model
    do
      if copyModel then
  ...
  battleCard.ResetSortingOrder = function(self, ...)
    -- function num : 0_0_168 , upvalues : BattleConfig, math
  ...
  battleCard.SetControlType = function(self, effectId, value, ...)
    -- function num : 0_0_177 , upvalues : BattleDisplayEffect, curState, BattleCardState, _ENV, headInfo, copyModel, copyFashionID, model, ResHelper, SkeletonAnimationUtil, cardInfo
  ...
  battleCard.UpdateAtkOrder = function(self, atkOrder, ...)
    -- function num : 0_0_178 , upvalues : headInfo
    if headInfo then
