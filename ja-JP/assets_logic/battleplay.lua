...
BattlePlay.PlayBuffAfterAtk = function(...)
  ...
  if IsBattleServer == nil and BattleData.skipBattle ~= true then
    ...
    ;
    (self.PlayBuff)(atkInfo, nil, BattleBuffDeductionRoundType.AFTER_IMMUNIZATION)
      ...
      if deductionRoundType == BattleBuffDeductionRoundType.BEFORE_SKILL then
        ...
        if deductionRoundType == BattleBuffDeductionRoundType.AFTER_SKILL then
          ...
          if deductionRoundType == BattleBuffDeductionRoundType.BEFORE_ASSIST then
            ...
            if deductionRoundType == BattleBuffDeductionRoundType.AFTER_DAMAGE then
              deductionRoundType2 = BattleBuffDeductionRoundType.AFTER_HIT_ALL
            end
          end
        end
      end
    ...
    if settleRoundType == BattleBuffSettleRoundType.AFTER_ATTACK then
      ...
      if settleRoundType == BattleBuffSettleRoundType.BEFORE_SKILL then
        ...
        if settleRoundType == BattleBuffSettleRoundType.AFTER_SKILL then
          ...
          if settleRoundType == BattleBuffSettleRoundType.BEFORE_ROUND then
            settleRoundType2 = BattleBuffSettleRoundType.BEFORE_RAGE_COVER
          end
        end
      end
    end
  ...
  for _,v in ipairs(allBuffTable) do
    if v.isDeal ~= true then
      ...
      if settleRoundType then
        ...
        -- DECOMPILER ERROR at PC113: Unhandled construct in 'MakeBoolean' P1
