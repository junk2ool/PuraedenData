...
require("HeroDungeon_Map007_1ByName")
require("HeroDungeon_HeroDungeonMonsterOtherByName")
require("HeroDungeon_HeroDungeonMonsterByName")
GetHeroDungeon_HeroPlotMap007Uis = function(ui, ...)
  -- function num : 0_0 , upvalues : _ENV
  local uis = {}
  uis.Effect_1_Grp = GetHeroDungeon_Map007_1Uis(ui:GetChild("Effect_1_Grp"))
  ...
  uis.Monster_04_Grp = GetHeroDungeon_HeroDungeonMonsterUis(ui:GetChild("Monster_04_Grp"))
  ...
  uis.Monster_25_Grp = GetHeroDungeon_HeroDungeonMonsterUis(ui:GetChild("Monster_25_Grp"))
