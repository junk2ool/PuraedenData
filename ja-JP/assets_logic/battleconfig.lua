...
BattleBuffSettleRoundType = {BEFORE_ROUND = 1, BEFORE_ATTACK = 2, AFTER_ATTACK = 3, BEFORE_BATTLE = 4, BEFORE_SKILL = 5, AFTER_SKILL = 6, BEFORE_ACTION = 8, AFTER_ACTION = 9, BEFORE_RAGE_COVER = 10, AFTER_CRIT_BEFORE_DMG = 11, AFTER_DAMAGE = 23}
BattleBuffDeductionRoundType = {NOW = 0, BEFORE_ROUND = 1, BEFORE_ATTACK = 2, AFTER_ATTACK = 3, BEFORE_BATTLE = 4, BEFORE_SKILL = 5, AFTER_SKILL = 6, AFTER_SKILL_ENEMY = 7, BEFORE_ACTION = 8, AFTER_ACTION = 9, BEFORE_ROUND_SINCE_2 = 10, AFTER_HIT = 11, AFTER_TREAT_DIRECT = 12, AFTER_ATTRACT = 13, BEFORE_ROUND_3 = 14, AFTER_CRIT = 15, DAMAGE_20_PER = 16, DAMAGE_KILL = 17, DAMAGE_DEAD = 18, DAMAGE_BUFF_ACTIVE = 19, PARTNER_DEAD = 20, ONE_ENEMY_ALIVE = 21, ENEMY_CONTROL = 22, AFTER_DAMAGE_ACTION = 23, BEFORE_ROUND_DELAY = 30, AFTER_DAMAGE = 31, NEAR_DEATH = 32, AFTER_FOUR_ATTACK = 33, BEFORE_ASSIST = 34, BEFORE_All_ATK = 35, AFTER_HIT_ALL = 36, AFTER_SKILL_ADD = 37, AFTER_SKILL_NO_SKILL = 38, DIE_SKILL_DIE = 39, AFTER_DEF_BLK = 40, AFTER_ENEMY_HEAL = 43, ODD_NUMBER = 41, EVEN_NUMBER = 42, AFTER_OWNER_CRIT = 45, DAMAGE_REACH_MAXHP = 46, AFTER_ASSIST = 48, AFTER_SHIELD_INVALID = 49, AFTER_SHIELD_GOT = 50, BEFORE_RAGE_COVER = 51, AFTER_IMMUNIZATION = 52, AFTER_ULTRA_SKILL_DMG = 53, AFTER_SMALL_SKILL_DMG = 54, AFTER_ATTACK_DMG = 55, AFTER_REVIVE = 56, AFTER_CRIT_BEFORE_DMG = 57, AFTER_CRIT_AFTER_DMG = 58, AFTER_CONTROLLED = 59}
_ENV.BattlePlaySettleRoundType = {NOW = 0, FIRST_ATTACK = 1}
_ENV.BattleBuffEffectCalType = {NONE = 0, VALUE = 1, ATK_PER = 2, HP_PER = 3, DEF_PER = 4, HURT_PER = 5, ATK_BASED_TARGET_DEAD = 6, ATK_BASED_SELF_DEAD = 7, ATK_BASED_ALL_DEAD = 8, ATK_BASED_TARGET_HP = 9, DAMAGE_BASED_TARGET_DEAD = 10, ATK_BASED_CLEAR_BUFF = 11, SPD_PER = 12, ATK_BASED_TARGET_HP_DEF = 13, STAR_CONFIG = 14, DEPEND_ROUND = 15, CUR_HP_PERCENT = 16, ENEMY_MAX_HP_PER = 17, DEPEND_ROUND_DIRECT = 18, HP_PER_CONFIG = 19, ATK_BASED_TARGET_HP_ATK = 20, ATK_BASED_TARGET_VALUE = 21, ATK_DEPEND_REMAIN_DANDER = 22, ATK_BASE_REMAIN_HP_PER = 23, ATK_BASE_STAR_CONFIG = 24, ATK_BASE_NEAR_CARD = 25, ATK_BASED_TARGET_HP_CONFIG = 26, CURENTDANDER_PER = 27, ATK_BASED_SELF_LIVE = 28, DEF_BASED_SELF_LIVE = 29, DEF_BASED_SELF_STAR = 30, LIMIT_DMG_AVERAGE_ENEMY = 31, BLK_BASED_SELF_STAR = 32, SPECIFY_BUFF_COUNT_ATK = 33, SPECIFY_BUFF_COUNT_DEF = 34, SPECIFY_BUFF_COUNT = 36, SPECIFY_BUFF_COUNT_STAR_SELF = 37, ATK_BASED_TARGET_HP_STAR = 38, NUMBER_OF_TARGET_SURVIVORS_STAR = 39, DANDER_UPPER_LIMIT_PER = 40, NUMBER_OF_SELF_SURVIVORS_ATK_STAR = 41, CUR_HP_VALUE = 42, DEF_PER_TOTAL = 43, DAMAGE_PER_ONESELF = 44, ENEMY_SURVIVE_NUM_MUL_DEF_FACTOR = 45, ENEMY_SURVIVE_NUM_MUL_FACTOR = 46}
...
_ENV.BattleCardAttributeID = {HP = 81050001, MAX_HP = 81050002, DANDER = 81050024}
...
_ENV.BattleDisplayEffect = {DAMAGE_EXTRA = 101, DAMAGE_PERSIST = 102, DAMAGE_PERCENT = 103, DAMAGE_REPEAT = 104, DEADLY = 105, STAMP = 106, COUNTER = 107, DIRECT_KILL = 108, UNIQUESKILL_DAMAGE_ADD = 109, DOUBLE_ATTACK = 110, FORCE_ASSIST = 111, SUMMON = 112, OFFER_REWARD = 113, WARLIKE = 116, ATTACK_DAMAGE_CHANGE = 117, HIT_DAMAGE_CHANGE = 118, DAMAGE_PERSIST_UP = 119, CRIT_PERSIST = 120, REB_PERSIST = 121, FIX_DAMAGE_PER = 122, DAMAGE_PERSIST_EXTRA = 123, DAMAGE_PERSIST_LIKE = 124, SKILL_ADDITIONAL = 125, DAMAGE_PERSIST_UP_EXTRA = 126, DAMAGE_PERSIST_LIKE_EX = 128, DAMAGE_IGNORE_SHIELD = 129, TRUE_DAMAGE = 130, FINIAL_DAMAGE = 131, STAMP_ICON = 150, STAMP_DEPEND_ROUND = 151, TREATMENT_EXTRA = 201, TREATMENT_PERSIST = 202, REVIVE_HP_RAGE = 203, SHIELD = 301, DAMAGE_REDUCE = 302, KEEP_ALIVE = 303, DAMAGE_SHARE = 304, BLOCK_PERSIST = 305, INVINCIBLE = 306, RESIST = 309, SHIELD_UP = 311, REC_PERSIST = 312, DAMAGE_DIVIDE = 313, EXTRA_DAMAGE_DIVIDE = 314, BLOCK_PERSIST_NO_EFFECT = 315, EXCHANGE_HP = 316, EXCHANGE_HP_SELF = 317, LOCK_HP = 318, LIKE_ALIVE = 319, SHIELD_INTENSIFY = 321, DAMAGE_TRANSFERENCE = 322, DAMAGE_BEAR_FROM_TRANS = 323, ENCHANTMENT = 401, PARALYSIS = 402, STUN = 403, SLEEP = 404, SILENT = 405, BLIND = 406, UNTREATMENT = 407, CONFUSION = 408, ATTRACT = 409, LIE = 412, FOCUS_ATTACK = 413, ATTACK_DEFEAT_NO_DANDER = 415, TRANSFIGURATION = 416, RELOADING = 417, Taunt = 419, DANDER_ABSORB = 607, NO_DEFEND_DANDER_ATTACK = 803, NO_DEFEND_DANDER_SMALL = 804, NO_DEFEND_DANDER_SKILL = 805, IMMUNE_COUNTER = 806, IGNORE_RESIST = 810, DIE_AFTER_SKILL = 812, ATK_NO_HEAL = 814, SMALL_SKILL_NO_HEAL = 815, SKILL_NO_HEAL = 816, CHANGE_HP_TO_ONE = 820}
...
_ENV.BuffTriggerCondition = {BUFF_TARGET_HP_PER = 1001, SELF_HP_PER = 1002, ATTACK_TARGET_HP_PER = 1003, ATTACK_TARGET_NOT_SWIMSUIT = 1004, COMPARE_HP_PERCENT = 1005, ATTACK_TARGET_TYPE = 1006, ATTACK_TARGET_HP_PER_EACH = 1007, COMPARE_DEFENCE = 1040, COMPARE_SPEED = 1050, SELF_TARGET_DANDER = 1011, TARGET_DANDER = 1112, SELF_TARGET_ATK = 1120, RANDOM = 1130, RANDOM_UP_HP = 1131, TARGET_BE_CRIT = 1060, SELF_CAMP_CARD_ALIVE = 2001, TARGET_HAVE_EFFECT = 2010, TARGET_HAVE_BUFF_TYPE = 2011, TARGET_HAVE_BUFF = 2012, TARGET_CARD_TYPE = 2013, TARGET_CARD_COUNT = 2014, TARGET_HP_PERCENT = 2015, TARGET_AROUND_NUM = 2016, COMPARE_ALIVE_NUM = 2017, SPECIFY_BUFF_COUNT = 2018, SPECIFY_BUFF_CUSTOM_COUNT = 2019, SPECIFY_POSITION = 2020, SPECIFY_POSITION_ATK = 2021, BATTLE_TYPE_PVE = 3000, BATTLE_TYPE_PLOT = 3001, BATTLE_TYPE_HERO = 3002, BATTLE_TYPE_DAILY = 3003, BATTLE_TYPE_TOWER = 3004, BATTLE_TYPE_EXPEDITION = 3005, BATTLE_TYPE_ARENA = 3006, BATTLE_TYPE_GUILD_WAR = 3007, BATTLE_TYPE_NOT_GUILD_WAR = 3008, BATTLE_TYPE_NOT_GUILD_WAR_AND_NO_PLOT = 3009, TARGET_IS_BOSS = 3010, TARGET_CAMP = 3011}
