...
_ENV.BuffTriggerCondition = {BUFF_TARGET_HP_PER = 1001, SELF_HP_PER = 1002, ATTACK_TARGET_HP_PER = 1003, ATTACK_TARGET_NOT_SWIMSUIT = 1004, COMPARE_HP_PERCENT = 1005, ATTACK_TARGET_TYPE = 1006, COMPARE_DEFENCE = 1040, COMPARE_SPEED = 1050, SELF_TARGET_DANDER = 1011, TARGET_DANDER = 1112, SELF_TARGET_ATK = 1120, RANDOM = 1130, RANDOM_UP_HP = 1131, SELF_CAMP_CARD_ALIVE = 2001, TARGET_HAVE_EFFECT = 2010, TARGET_HAVE_BUFF_TYPE = 2011, TARGET_HAVE_BUFF = 2012, TARGET_CARD_TYPE = 2013, TARGET_CARD_COUNT = 2014, TARGET_HP_PERCENT = 2015, TARGET_AROUND_NUM = 2016, COMPARE_ALIVE_NUM = 2017, SPECIFY_BUFF_COUNT = 2018, SPECIFY_BUFF_CUSTOM_COUNT = 2019, BATTLE_TYPE_PVE = 3000, BATTLE_TYPE_PLOT = 3001, BATTLE_TYPE_HERO = 3002, BATTLE_TYPE_DAILY = 3003, BATTLE_TYPE_TOWER = 3004, BATTLE_TYPE_EXPEDITION = 3005, BATTLE_TYPE_ARENA = 3006, BATTLE_TYPE_GUILD_WAR = 3007, BATTLE_TYPE_NOT_GUILD_WAR = 3008, BATTLE_TYPE_NOT_GUILD_WAR_AND_NO_PLOT = 3009, TARGET_IS_BOSS = 3010, TARGET_CAMP = 3011}
