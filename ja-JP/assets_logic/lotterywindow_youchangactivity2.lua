...
LotteryWindow_YouChangActivity2 = {}
local LotteryCardId = {day = 24001021}
local CostType = {Free = 1, Ticket = 2, Diamond = 3}
local countTimer = nil
local lotteryType = LotteryType.YouChangHuoDongUp2
...
LotteryWindow_YouChangActivity2.RefreshWindow = function(_uis, ...)
  ...
  ;
  (LotteryWindow_YouChangActivity2.PreLoadFxMain)(uis)
end

-- DECOMPILER ERROR at PC17: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_YouChangActivity2.HideOrShowFxMain = function(isShow, ...)
...
LotteryWindow_YouChangActivity2.PreLoadFxMain = function(uis, ...)
...
LotteryWindow_YouChangActivity2.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_YouChangActivity2.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_LuckBagGrp).SpecialOneTimeBtn, LotteryCardId.day, 0, true)
end

-- DECOMPILER ERROR at PC26: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_YouChangActivity2.SetButtonInfo = function(btn, id, freeNum, dayLottery, sound, ...)
...
LotteryWindow_YouChangActivity2.ReceiveDrawedData = function(para, ...)
...
LotteryWindow_YouChangActivity2.ShowResult = function(para, ...)
...
LotteryWindow_YouChangActivity2.OnClose = function(...)
