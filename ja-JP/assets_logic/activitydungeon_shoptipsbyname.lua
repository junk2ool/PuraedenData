...
require("ActivityDungeon_DayBuyNumberByName")
GetActivityDungeon_ShopTipsUis = function(ui, ...)
  -- function num : 0_0 , upvalues : _ENV
  local uis = {}
  uis.ItemNameTxt = ui:GetChild("ItemNameTxt")
  uis.IconLoader = ui:GetChild("IconLoader")
  uis.RedDollGrp = GetCommonResource_RedDollUis(ui:GetChild("RedDollGrp"))
  uis.DayBuyNumber = GetActivityDungeon_DayBuyNumberUis(ui:GetChild("DayBuyNumber"))
