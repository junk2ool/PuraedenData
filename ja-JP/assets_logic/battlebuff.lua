...
, curRoundActive = false, parentBuffDeductionType = nil}
            ...
            if baseType == BattleBuffEffectCalType.VALUE then
              ...
              if baseType == BattleBuffEffectCalType.ATK_PER then
                ...
                if baseType == BattleBuffEffectCalType.DEF_PER then
                  ...
                  if baseType == BattleBuffEffectCalType.DEF_PER_TOTAL then
                    if baseDependType == BattleBuffEffectDependType.ATK_CARD then
                      totalValue = totalValue + (math.ceil)(atkCard:GetDef() * baseValue / 10000)
                    else
                      if baseDependType == BattleBuffEffectDependType.DEF_CARD then
                        totalValue = totalValue + (math.ceil)(defCard:GetDef() * baseValue / 10000)
                      end
                    end
                  else
                                                                                                                                          ...
                                                                                                                                          if baseType == BattleBuffEffectCalType.BLK_BASED_SELF_STAR then
                                                                                                                                            ...
                                                                                                                                            do
                                                                                                                                              if baseType == BattleBuffEffectCalType.SPECIFY_BUFF_COUNT then
                                                                                                                                                ...
                                                                                                                                                do
                                                                                                                                                  if baseType == BattleBuffEffectCalType.SPECIFY_BUFF_COUNT_STAR_SELF then
                                                                                                                                                    local config = self:GetBuffConfig()
                                                                                                                                                    local starTable = split(config.star_config, ":")
                                                                                                                                                    local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                    local value = tonumber(starTable[cardStar])
                                                                                                                                                    ...
                                                                                                                                                    do
                                                                                                                                                      if baseType == BattleBuffEffectCalType.ATK_BASED_TARGET_HP_STAR then
                                                                                                                                                        local per = (math.floor)((1 - atkCard:GetHp() / atkCard:GetMaxHp(true)) / 0.1)
                                                                                                                                                        local config = self:GetBuffConfig()
                                                                                                                                                        local strTable = split(config.star_config, ":")
                                                                                                                                                        local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                        ...
                                                                                                                                                        do
                                                                                                                                                          if baseType == BattleBuffEffectCalType.NUMBER_OF_TARGET_SURVIVORS_STAR then
                                                                                                                                                            local config = self:GetBuffConfig()
                                                                                                                                                            local starTable = split(config.star_config, ":")
                                                                                                                                                            local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                            local value = tonumber(starTable[cardStar])
                                                                                                                                                            ...
                                                                                                                                                            do
                                                                                                                                                              if baseType == BattleBuffEffectCalType.DANDER_UPPER_LIMIT_PER then
                                                                                                                                                                ...
                                                                                                                                                                local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                                local value = tonumber(starTable[cardStar])
                                                                                                                                                                totalValue = (math.ceil)(atkCard:GetMaxDander() / 100 * value)
                                                                                                                                                              else
                                                                                                                                                                do
                                                                                                                                                                  if baseType == BattleBuffEffectCalType.NUMBER_OF_SELF_SURVIVORS_ATK_STAR then
                                                                                                                                                                    ...
                                                                                                                                                                    do
                                                                                                                                                                      if baseType == BattleBuffEffectCalType.CUR_HP_VALUE then
                                                                                                                                                                        local config = self:GetBuffConfig()
                                                                                                                                                                        local starTable = (split(config.star_config, ":"))
                                                                                                                                                                        local card = nil
                                                                                                                                                                        if baseDependType == BattleBuffEffectDependType.ATK_CARD then
                                                                                                                                                                        ...
                                                                                                                                                                        if card then
                                                                                                                                                                          local cardStar = (card:GetCardInfo()):GetStar()
                                                                                                                                                                          local value = tonumber(starTable[cardStar]) * 0.0001
                                                                                                                                                                          totalValue = (math.ceil)(card:GetHp() * value)
                                                                                                                                                                        end
                                                                                                                                                                      else
                                                                                                                                                                        do
                                                                                                                                                                          if baseType == BattleBuffEffectCalType.DAMAGE_PER_ONESELF then
                                                                                                                                                                            local value = baseValue * 0.0001
                                                                                                                                                                            for i,v in ipairs(atkInfo.defCardsInfo) do
                                                                                                                                                                              if v.defCardUid == defCard:GetCardUid() then
                                                                                                                                                                                local damage = (math.abs)(v.hpDef) + v.absorbDamage
                                                                                                                                                                                totalValue = (math.ceil)(damage * value)
                                                                                                                                                                                break
                                                                                                                                                                              end
                                                                                                                                                                            end
                                                                                                                                                                          else
                                                                                                                                                                            do
                                                                                                                                                                              if baseType == BattleBuffEffectCalType.ENEMY_SURVIVE_NUM_MUL_DEF_FACTOR then
                                                                                                                                                                                local config = self:GetBuffConfig()
                                                                                                                                                                                local starTable = split(config.star_config, ":")
                                                                                                                                                                                local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                                                local factor = tonumber(starTable[cardStar]) * 0.0001
                                                                                                                                                                                local num = #(BattleData.GetAliveCards)(~atkCard:GetCampFlag() & 1)
                                                                                                                                                                                totalValue = (math.ceil)(num * atkCard:GetDef(true) * factor)
                                                                                                                                                                              else
                                                                                                                                                                                do
                                                                                                                                                                                  if baseType == BattleBuffEffectCalType.ENEMY_SURVIVE_NUM_MUL_FACTOR then
                                                                                                                                                                                    local config = self:GetBuffConfig()
                                                                                                                                                                                    local starTable = split(config.star_config, ":")
                                                                                                                                                                                    local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                                                    local factor = tonumber(starTable[cardStar]) * 0.0001
                                                                                                                                                                                    local num = #(BattleData.GetAliveCards)(~atkCard:GetCampFlag() & 1)
                                                                                                                                                                                    totalValue = (math.ceil)(num * factor)
                                                                                                                                                                                  end
                                                                                                                                                                                  do
                                                                                                                                                                                    if upType == BattleBuffEffectCalType.VALUE then
                                                                                                                                                                                      ...
                                                                                                                                                                                      if upType == BattleBuffEffectCalType.ATK_PER then
                                                                                                                                                                                        ...
                                                                                                                                                                                        if upType == BattleBuffEffectCalType.DEF_PER then
                                                                                                                                                                                          ...
                                                                                                                                                                                          if upType == BattleBuffEffectCalType.DEF_PER_TOTAL then
                                                                                                                                                                                            if baseDependType == BattleBuffEffectDependType.ATK_CARD then
                                                                                                                                                                                              totalValue = totalValue + (math.ceil)(atkCard:GetDef() * upValue / 10000)
                                                                                                                                                                                            else
                                                                                                                                                                                              if baseDependType == BattleBuffEffectDependType.DEF_CARD then
                                                                                                                                                                                                totalValue = totalValue + (math.ceil)(defCard:GetDef() * upValue / 10000)
                                                                                                                                                                                              end
                                                                                                                                                                                            end
                                                                                                                                                                                          else
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            if upType == BattleBuffEffectCalType.DANDER_UPPER_LIMIT_PER then
                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                              do
                                                                                                                                                                                                                                                                                if upType == BattleBuffEffectCalType.NUMBER_OF_SELF_SURVIVORS_ATK_STAR then
                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                  do
                                                                                                                                                                                                                                                                                    if upType == BattleBuffEffectCalType.CUR_HP_VALUE then
                                                                                                                                                                                                                                                                                      local config = self:GetBuffConfig()
                                                                                                                                                                                                                                                                                      local starTable = (split(config.star_config, ":"))
                                                                                                                                                                                                                                                                                      local card = nil
                                                                                                                                                                                                                                                                                      if baseDependType == BattleBuffEffectDependType.ATK_CARD then
                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                      do
                                                                                                                                                                                                                                                                                        if upType == BattleBuffEffectCalType.DAMAGE_PER_ONESELF then
                                                                                                                                                                                                                                                                                          local value = upValue * 0.0001
                                                                                                                                                                                                                                                                                          for i,v in ipairs(atkInfo.defCardsInfo) do
                                                                                                                                                                                                                                                                                            if v.defCardUid == defCard:GetCardUid() then
                                                                                                                                                                                                                                                                                              local damage = (math.abs)(v.hpDef) + v.absorbDamage
                                                                                                                                                                                                                                                                                              totalValue = (math.ceil)(damage * value)
                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                          do
                                                                                                                                                                                                                                                                                            if upType == BattleBuffEffectCalType.ENEMY_SURVIVE_NUM_MUL_DEF_FACTOR then
                                                                                                                                                                                                                                                                                              local config = self:GetBuffConfig()
                                                                                                                                                                                                                                                                                              local starTable = split(config.star_config, ":")
                                                                                                                                                                                                                                                                                              local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                                                                                                                                                              local factor = tonumber(starTable[cardStar]) * 0.0001
                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                              do
                                                                                                                                                                                                                                                                                                if upType == BattleBuffEffectCalType.ENEMY_SURVIVE_NUM_MUL_FACTOR then
                                                                                                                                                                                                                                                                                                  local config = self:GetBuffConfig()
                                                                                                                                                                                                                                                                                                  local starTable = split(config.star_config, ":")
                                                                                                                                                                                                                                                                                                  local cardStar = (atkCard:GetCardInfo()):GetStar()
                                                                                                                                                                                                                                                                                                  local factor = tonumber(starTable[cardStar]) * 0.0001
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    do
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      do
                                                                                                                                                                                                                                                                                                        do
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          -- DECOMPILER ERROR at PC2306: LeaveBlock: unexpected jumping out DO_STMT
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          -- DECOMPILER ERROR at PC2306: LeaveBlock: unexpected jumping out IF_ELSE_STMT

                                                                                                                                                                                                                                                                                                          -- DECOMPILER ERROR at PC2306: LeaveBlock: unexpected jumping out IF_STMT
                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                          -- DECOMPILER ERROR at PC2306: LeaveBlock: unexpected jumping out IF_THEN_STMT
    ...
    battleBuff.SetRevivedInfo = function(self, recoverHp, recoverRage, ...)
    -- function num : 0_0_47
    if not self.revivedInfo then
      self.revivedInfo = {}
    end
    -- DECOMPILER ERROR at PC6: Confused about usage of register: R3 in 'UnsetPending'

    ;
    (self.revivedInfo).hp = recoverHp
    -- DECOMPILER ERROR at PC8: Confused about usage of register: R3 in 'UnsetPending'

    ;
    (self.revivedInfo).rage = recoverRage
  end

    battleBuff.GetRevivedInfo = function(self, ...)
    -- function num : 0_0_48
    return self.revivedInfo
  end
                      ...
                      if trigger_condition == BuffTriggerCondition.COMPARE_HP_PERCENT then
                        ...
                        do
                          if trigger_condition == BuffTriggerCondition.COMPARE_DEFENCE then
                            ...
                            do
                              if trigger_condition == BuffTriggerCondition.COMPARE_SPEED then
                                return CompareNum(trigger_type, atkCard:GetSpd(), card:GetSpd())
                              else
                                                      ...
                                                      do
                                                        if trigger_condition == BuffTriggerCondition.TARGET_HAVE_EFFECT then
                                                          ...
                                                          do
                                                            ...
                                                            elseif trigger_condition == BuffTriggerCondition.SPECIFY_POSITION_ATK then
                                                              local splits = split(buffConfig.trigger_value, ":")
                                                              local cardPos = atkCard:GetPosIndex()
                                                              cardPos = cardPos % 100
                                                              if cardPos > 10 then
                                                                cardPos = cardPos - 7
                                                              end
                                                              ...
                                                              if selfCamp ~= targetCamp then
                                                                ...
                                                                if selfCamp == targetCamp then
                                                                  do
                                                                    ...
                                                                    if trigger_condition == BuffTriggerCondition.TARGET_BE_CRIT then
                                                                      for i,v in ipairs(atkInfo.defCardsInfo) do
                                                                        if v.defCardUid == card:GetCardUid() and v.isCrit then
                                                                          return true
                                                                        end
                                                                      end
                                                                    else
    ...
    if activeForever == 1 then
      for _,v in ipairs(effectTable) do
        ...
        if attributeId == BattleCardAttributeID.HP then
          ...
          if buffData.revivedInfo then
            card:SetRevivedInfo(buffData.revivedInfo)
          end
...
BattleBuff.DealRealHpLoss = function(defCard, damage, isRoundAtk, damageAdd, skillType, CaseEffectID, ignoreReduceDmg, ...)
  -- function num : 0_8 , upvalues : _ENV, BattleBuffMgr, self, BattleBuffOprType, ipairs, BattleDisplayEffect, math, BattleBuffDeductionRoundType
          ...
          do
            ...
            if IsBattleServer == true then
              do
                ...
                local finialDamageAdd = 0
                local finialDmgAddList = false
                for _,buff in ipairs(buffTable) do
                  ...
                  for _,v in ipairs(effectTable) do
                    ...
                    if isHurt == true then
                      ...
                      if not ignoreReduceDmg and (self.IsDamageReduce)(effectId) == true and isCanEffect == true then
                        buff:SetCurRoundActive(true)
                      ...
                      if not ignoreReduceDmg and (self.IsResist)(effectId) == true then
                      ...
                      if effectId == BattleDisplayEffect.FINIAL_DAMAGE then
                        if not finialDmgAddList then
                          finialDmgAddList = {}
                        end
                        ;
                        (table.insert)(finialDmgAddList, value)
                      end
                    end
                  end
                end
                if finialDmgAddList and next(finialDmgAddList) then
                  for i,v in ipairs(finialDmgAddList) do
                    finialDamageAdd = finialDamageAdd + v
                  end
                end
                ...
                damage = (math.ceil)(damage * (1 + (finialDamageAdd) / 10000))
                ...
                totalDamage = damage
                do
                  if isHurt == true and CaseEffectID ~= BattleDisplayEffect.DAMAGE_IGNORE_SHIELD then
                    ...
                    if hasShield and damage > 0 then
                      (BattleDataCount.UpdateBuffCount)(atkInfo, BattleBuffDeductionRoundType.AFTER_SHIELD_INVALID, defCard:GetPosIndex())
                    end
                  end
