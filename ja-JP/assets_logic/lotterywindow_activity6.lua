...
LotteryWindow_Activity6 = {}
local LotteryCardId = {single = 24000111, ten = 24000112, day = 24000113}
local CostType = {Free = 1, Ticket = 2, Diamond = 3}
local countTimer = nil
local lotteryType = LotteryType.HuoDongUp6
...
LotteryWindow_Activity6.RefreshWindow = function(_uis, ...)
...
LotteryWindow_Activity6.HideOrShowFxMain = function(isShow, ...)
...
LotteryWindow_Activity6.PreLoadFxMain = function(uis, ...)
...
LotteryWindow_Activity6.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_Activity6.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).OneTimeBtn, LotteryCardId.single, lData.onceFreeNum)
  ;
  (LotteryWindow_Activity6.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).TenTimeBtn, LotteryCardId.ten, lData.moreFreeNum)
  ;
  (LotteryWindow_Activity6.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_NewCardUpGrp).SpecialOneTimeBtn, LotteryCardId.day, 0, lData.dayLottery)
end

-- DECOMPILER ERROR at PC28: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_Activity6.SetButtonInfo = function(btn, id, freeNum, dayLottery, sound, ...)
...
LotteryWindow_Activity6.ReceiveDrawedData = function(para, ...)
...
LotteryWindow_Activity6.ShowResult = function(para, ...)
...
LotteryWindow_Activity6.OnClose = function(...)
