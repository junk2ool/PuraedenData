...
require("ActivityDungeonTwo_StageListByName")
GetActivityDungeonTwo_ChoiceShopUis = function(ui, ...)
  ...
  uis.StageList = GetActivityDungeonTwo_StageListUis(ui:GetChild("StageList"))
