...
LotteryWindow_YouChangActivity3 = {}
local LotteryCardId = {day = 24001031}
local CostType = {Free = 1, Ticket = 2, Diamond = 3}
local countTimer = nil
local lotteryType = LotteryType.YouChangHuoDongUp3
...
LotteryWindow_YouChangActivity3.RefreshWindow = function(_uis, ...)
  ...
  ;
  (LotteryWindow_YouChangActivity3.PreLoadFxMain)(uis)
end

-- DECOMPILER ERROR at PC17: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_YouChangActivity3.HideOrShowFxMain = function(isShow, ...)
...
LotteryWindow_YouChangActivity3.PreLoadFxMain = function(uis, ...)
...
LotteryWindow_YouChangActivity3.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_YouChangActivity3.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_LuckBagGrp).SpecialOneTimeBtn, LotteryCardId.day, 0, true)
end

-- DECOMPILER ERROR at PC26: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_YouChangActivity3.SetButtonInfo = function(btn, id, freeNum, dayLottery, sound, ...)
...
LotteryWindow_YouChangActivity3.ReceiveDrawedData = function(para, ...)
...
LotteryWindow_YouChangActivity3.ShowResult = function(para, ...)
...
LotteryWindow_YouChangActivity3.OnClose = function(...)
