...
require("HeroDungeon_Map008_1ByName")
require("HeroDungeon_HeroDungeonMonsterByName")
require("HeroDungeon_HeroDungeonMonsterOtherByName")
GetHeroDungeon_HeroPlotMap008Uis = function(ui, ...)
  -- function num : 0_0 , upvalues : _ENV
  local uis = {}
  uis.Effect_1_Grp = GetHeroDungeon_Map008_1Uis(ui:GetChild("Effect_1_Grp"))
  ...
  uis.Monster_14_Grp = GetHeroDungeon_HeroDungeonMonsterUis(ui:GetChild("Monster_14_Grp"))
  ...
  uis.Monster_18_Grp = GetHeroDungeon_HeroDungeonMonsterUis(ui:GetChild("Monster_18_Grp"))
