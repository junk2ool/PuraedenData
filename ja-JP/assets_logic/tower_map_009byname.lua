...
GetTower_Map_009Uis = function(ui, ...)
  -- function num : 0_0 , upvalues : _ENV
  local uis = {}
  uis.Layer = GetTower_Layer_009Uis(ui:GetChild("Layer"))
  uis.LayerNumber = GetTower_LayerNumberUis(ui:GetChild("LayerNumber"))
  uis.Line_01 = GetTower_Line_2Uis(ui:GetChild("Line_01"))
