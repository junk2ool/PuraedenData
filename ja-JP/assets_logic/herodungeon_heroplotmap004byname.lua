...
require("HeroDungeon_Map004_1ByName")
require("HeroDungeon_HeroDungeonMonsterByName")
require("HeroDungeon_HeroDungeonMonsterOtherByName")
GetHeroDungeon_HeroPlotMap004Uis = function(ui, ...)
  -- function num : 0_0 , upvalues : _ENV
  local uis = {}
  uis.Effect_1_Grp = GetHeroDungeon_Map004_1Uis(ui:GetChild("Effect_1_Grp"))
  ...
  uis.Monster_26_Grp = GetHeroDungeon_HeroDungeonMonsterOtherUis(ui:GetChild("Monster_26_Grp"))
  uis.Monster_27_Grp = GetHeroDungeon_HeroDungeonMonsterUis(ui:GetChild("Monster_27_Grp"))
