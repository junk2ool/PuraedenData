...
_ENV.WindowMsgEnum = {
HomeWindow = {E_MSG_UPDATE_ACTOR_INFO = 1, E_MSG_UPDATE_ACTIVITY_VISIBLE = 2, E_MSG_RESET_TASK_SPINE = 3, E_MSG_UPDATE_BG = 4, E_MSG_UPDATE_BANNER = 5, E_MSG_UPDATE_BANNER_REDDOT = 6, E_MSG_UPDATE_FREE_10_LOTTERY = 7, E_MSG_REFRESH_PRODUCT = 8}
, 
