...
, 
RelicMainWindow = {name = "RelicMainWindow", package = "Relic", comName = "Relic", hideBelow = true}
, 
RelicShopWindow = {name = "RelicShopWindow", package = "Relic", comName = "ChoiceShop", hideBelow = false}
, 
RelicBattlePreviewWindow = {name = "RelicBattlePreviewWindow", package = "Relic", comName = "BattlePreviewWindow", hideBelow = false, notReopen = true}
, 
...
_ENV.WindowMsgEnum = {
HomeWindow = {E_MSG_UPDATE_ACTOR_INFO = 1, E_MSG_UPDATE_ACTIVITY_VISIBLE = 2, E_MSG_RESET_TASK_SPINE = 3, E_MSG_UPDATE_BG = 4, E_MSG_UPDATE_BANNER = 5, E_MSG_UPDATE_BANNER_REDDOT = 6, E_MSG_UPDATE_FREE_10_LOTTERY = 7, E_MSG_REFRESH_PRODUCT = 8, E_MSG_RESET_PRODUCT = 9}
, 
...
, 
CardWindow = {E_MSG_CARD_INFO = 1, E_MSG_CARD_LEVELUP = 2, E_MSG_CARD_STAGEUP = 3, E_MSG_CARD_STAGEUPPROPERTY = 4, E_MSG_CARD_SKILLGET = 5, E_MSG_CARD_CARDGET = 6, E_MSG_CARD_SKILLUP = 7, E_MSG_CARD_SKILLDETAIL = 8, E_MSG_CARD_GOODCHANGE = 9, E_MSG_CARD_REFRESHCARDLISTBUTTOM = 10, E_MSG_CARD_SENDCARDDATATOINFO = 11, E_MSG_CARD_STARUP = 12, E_MSG_CARD_SETFASHIONID = 13, E_MSG_CARD_CLOSECARDCHOICE = 14, E_MSG_CARD_CHOICESELECTCARDLIST = 15, E_MSG_CARD_PIECE_EXCHANGE_COUNT = 16, E_MSG_CARD_AFTER_EXCHANGE = 17, E_MSG_CARD_STAR_UP_EFFECT = 18, E_MSG_CARD_PICE_TO_CARD = 19, E_MSG_CARD_USE_EXP_PROP = 20, E_MSG_CARD_CLOSECARDINFO = 21, E_MSG_CARD_CHOICEWINDOWSELECT = 22, E_MSG_CARD_LEVELUP_TRUE = 23, E_MSG_CARD_STAGEUP_TRUE = 24, E_MSG_CARD_STARUP_TRUE = 25, E_MSG_CARD_CLOSEGET_TOLIST = 26, E_MSG_CARD_LIST_SCROLL = 27, E_MSG_CARD_SWEEP_END = 28, E_MSG_GETWAY_CLOESED = 29, E_MSG_CARD_SETMAINFASHION = 30, E_MSG_CARD_CLOSECARDLOOK = 31, E_MSG_CARD_AFTERCLOSEGOLD = 32, E_MSG_CARD_SEAL_INFORMATION = 40, E_MSG_CARD_REFRESH_FC = 41, E_MSG_CARD_SEAL_SKILL_SHOW = 42}
, 
...
, 
ShopWindow = {E_MSG_REFRESH = 1, E_MSG_REFRESH_ITEM = 2, E_MSG_SET_TYPE = 3, E_MSG_GET_ACTIVITYINFO = 4, E_MSG_CLEAR_FREEGIFTREDDOT = 5, E_MSG_CLEAR_CHECKPRODUCTSTATE = 6}
, 
...
, 
CardWindow = {"SkillIcon", "SkillIconImprint"}
, 
