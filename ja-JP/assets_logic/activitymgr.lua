...
ActivityMgr.ActivityType = {SevenTask = 1, ActivityDungeon = 2, Drop_Multiple = 3, Limit_Gift = 4, Daily_Pay = 5, Total_Pay = 6, Activity_Lottery = 8, Total_Login = 7, Newbie_Lottery = 9, Free_Lottery = 10, Prize = 11, Relic = 12, LotteryIntergral = 13, Return = 15}
...
ActivityMgr.GetMaxInteger = function(actId, ...)
  -- function num : 0_28 , upvalues : maxInteger, _ENV
