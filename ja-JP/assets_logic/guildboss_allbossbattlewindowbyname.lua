...
require("GuildBoss_AllBossBattleByName")
GetGuildBoss_AllBossBattleWindowUis = function(ui, ...)
  ...
  uis.AllBossBattle = GetGuildBoss_AllBossBattleUis(ui:GetChild("AllBossBattle"))
  uis.root = ui
  return uis
end
