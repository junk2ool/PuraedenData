...
LotteryWindow_YouChangActivity4 = {}
local LotteryCardId = {day = 24001041}
local CostType = {Free = 1, Ticket = 2, Diamond = 3}
local countTimer = nil
local lotteryType = LotteryType.YouChangHuoDongUp4
...
LotteryWindow_YouChangActivity4.RefreshWindow = function(_uis, ...)
...
LotteryWindow_YouChangActivity4.HideOrShowFxMain = function(isShow, ...)
...
LotteryWindow_YouChangActivity4.ReceiveInitData = function(...)
  ...
  ;
  (LotteryWindow_YouChangActivity4.SetButtonInfo)(((uis.LotteryPanelGrp).GetCha_LuckBagGrp).SpecialOneTimeBtn, LotteryCardId.day, 0, true)
end

-- DECOMPILER ERROR at PC26: Confused about usage of register: R8 in 'UnsetPending'

LotteryWindow_YouChangActivity4.SetButtonInfo = function(btn, id, freeNum, dayLottery, sound, ...)
...
LotteryWindow_YouChangActivity4.ShowResult = function(para, ...)
...
LotteryWindow_YouChangActivity4.OnClose = function(...)
